/**
 * EnhancedApp - App entry point with micro-interactions and animations
 */
...
// Import our enhanced dashboard example
import AnimatedDashboardExample from './components/examples/AnimatedDashboardExample';
        ...
        <Suspense fallback={<LoadingFallback />}>
          <OperatorProvider>
            <LiveDashboardProvider>
              <Router>
                <Routes>
                  <Route path="/*" element={<AnimatedDashboardExample />} />
                </Routes>
              </Router>
            </LiveDashboardProvider>
          </OperatorProvider>
